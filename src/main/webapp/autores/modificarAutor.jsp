...
<body>
	...
	<form role= "form" action="<%=url%>AutoresController" method= "POST"> 
		<input type="hidden" name="op" name= "modificar"/><!-- Para almacenar informacion que el usuario no puede ver directamente -->
		<input type= "hidden" name= "id" value= "<%=a.getIdAutor()%>"/>
			<label for = "nombre">Nombre del Autor: </label>
			<input type="text" name = "nom" id="nombre" value="<%=a.getNombre()%>"/><br>
